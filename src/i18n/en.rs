...
pub(super) fn text(key: TextKey) -> &'static str {
    match key {
        ...
        TextKey::AuthSuccessTitle => "Signed in to Fastpotify",
        TextKey::AuthSuccessHeading => "You're signed in",
        TextKey::AuthSuccessBody => "You can close this tab and go back to Fastpotify.",
        TextKey::AuthFailureTitle => "Sign-in failed",
        TextKey::AuthFailureHeading => "Sign-in didn't complete",
        TextKey::AuthFailureReturn => "Return to Fastpotify and try again.",
        TextKey::MilkdropPresetKept => "Preset kept",
        TextKey::MilkdropPresetFree => "Preset free again",
        TextKey::MilkdropRandomOrder => "Random order",
        TextKey::MilkdropFolderOrder => "Folder order",
        TextKey::MilkdropSongWhenChanged => "Song title: when it changes",
        TextKey::MilkdropSongAlways => "Song title: always",
        TextKey::MilkdropSongOff => "Song title: off",
        TextKey::MilkdropNothingPlaying => "Nothing playing",
        TextKey::MilkdropNoPreset => "No preset",
        TextKey::MilkdropHelpPresets => "PRESETS",
        TextKey::MilkdropHelpPlayback => "PLAYBACK",
        TextKey::MilkdropHelpWindow => "WINDOW",
        TextKey::MilkdropHelpShow => "SHOW",
        TextKey::MilkdropHelpNextPreset => "Next preset",
        TextKey::MilkdropHelpPreviousPreset => "Previous preset",
        TextKey::MilkdropHelpBeatCut => "Next preset, cut on the beat",
        TextKey::MilkdropHelpKeepPreset => "Keep this preset",
        TextKey::MilkdropHelpOrder => "Random or folder order",
        TextKey::MilkdropHelpRightClick => "Next preset",
        TextKey::MilkdropHelpPlayPause => "Play or pause",
        TextKey::MilkdropHelpPreviousNextSong => "Previous or next song",
        TextKey::MilkdropHelpVolume => "Volume up or down",
        TextKey::MilkdropHelpMute => "Mute or unmute",
        TextKey::MilkdropHelpLike => "Like or unlike the playing song",
        TextKey::MilkdropHelpShuffle => "Shuffle",
        TextKey::MilkdropHelpFullscreen => "Full screen",
        TextKey::MilkdropHelpLeaveFullscreen => "Leave full screen, or close",
        TextKey::MilkdropHelpMoveResize => "Move it; drag a corner to resize",
        TextKey::MilkdropHelpTheseKeys => "These keys",
        TextKey::MilkdropHelpSongTitle => "Song title: on a change, always, off",
        TextKey::MilkdropHelpPresetName => "This preset's name, on or off",
        TextKey::MilkdropHelpFps => "FPS, on or off",
        TextKey::MacMenuCheckUpdates => "Check for Updates…",
        TextKey::MacMenuSettings => "Settings…",
        TextKey::MacMenuFile => "File",
        TextKey::MacMenuCloseWindow => "Close Window",
        TextKey::MacMenuEdit => "Edit",
        TextKey::MacMenuCut => "Cut",
        TextKey::MacMenuCopy => "Copy",
        TextKey::MacMenuPaste => "Paste",
        TextKey::MacMenuSelectAll => "Select All",
        TextKey::MacMenuPlayback => "Playback",
        TextKey::MacMenuPlayPause => "Play / Pause",
        TextKey::MacMenuNextTrack => "Next Track",
        TextKey::MacMenuPreviousTrack => "Previous Track",
        TextKey::MacMenuSeekForward => "Seek Forward (10s)",
        TextKey::MacMenuSeekBackward => "Seek Backward (10s)",
        TextKey::MacMenuShuffle => "Shuffle",
        TextKey::MacMenuRepeat => "Repeat",
        TextKey::MacMenuIncreaseVolume => "Increase Volume",
        TextKey::MacMenuDecreaseVolume => "Decrease Volume",
        TextKey::MacMenuMute => "Mute",
        TextKey::MacMenuView => "View",
        TextKey::MacMenuBack => "Back",
        TextKey::MacMenuForward => "Forward",
        TextKey::MacMenuHome => "Home",
        TextKey::MacMenuSearch => "Search",
        TextKey::MacMenuLikedSongs => "Liked Songs",
        TextKey::MacMenuToggleSidebar => "Toggle Sidebar",
        TextKey::MacMenuQueue => "Queue",
        TextKey::MacMenuToggleFullscreen => "Toggle Full Screen",
        TextKey::MacMenuWindow => "Window",
        TextKey::MacMenuMinimize => "Minimize",
        TextKey::MacMenuZoom => "Zoom",
        TextKey::MacMenuBringAllToFront => "Bring All to Front",
        TextKey::MacMenuHelp => "Help",
        TextKey::MacMenuKeyboardShortcuts => "Keyboard Shortcuts",
        TextKey::MacMenuGithub => "Fastpotify on GitHub",
        TextKey::NoticeDownloadingMilkdropPacks => "Downloading MilkDrop preset packs",
        TextKey::NoticeFetchPresetsFailedPrefix => "Couldn't fetch presets",
    }
}
...
pub(super) fn message(message: &Message) -> String {
    match message {
        ...
        Message::NoticeMilkdropPresetsAdded { count } => match count {
            1 => "Added 1 MilkDrop preset".to_string(),
            count => format!("Added {count} MilkDrop presets"),
        },
        Message::NoticeDownloadingPresetPack { name } => {
            format!("Downloading {name} presets")
        }
        Message::NoticeSkinAdded { name } => format!("Added {name} skin"),
    }
}
